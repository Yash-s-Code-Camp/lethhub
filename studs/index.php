<?php 
    ...
    $result_t = mysqli_query($conn, $sql_student);

    // Associative array
    $student = mysqli_fetch_assoc($result_t);
...
?>
    ...
    <?php
        ...
        if(isset($_POST["add_class"])){
            ...
            $sql_code = "INSERT INTO classes (student_id, class_name, class_code)
                            VALUES ($student_id, '$class_name', '$class_code')";
            //echo $sql_insert;
    ...
    <table  class="table table-hover">
            ...
            <tbody>
    <?php
        $sql_class = "SELECT * FROM classes WHERE `student_id`=".$student["id"];
        ...
        if (mysqli_num_rows($result_c) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result_c)) {
                ...
                <td><a class=\"btn btn-success float-md-right\" href=\"class.php?id=".$row["id"]."\">Manage</a></td>
                </tr>";
            }
        } else {
            echo "0 results";
